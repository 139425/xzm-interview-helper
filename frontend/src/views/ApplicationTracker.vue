<template>
  <WorkspaceFrame mode="applications" title="投递追踪" eyebrow="CAREER PIPELINE" mark="投">
    <template #actions>
      <button type="button" class="primary workspace-primary" @click="openCreate">＋ 手动录入</button>
    </template>
