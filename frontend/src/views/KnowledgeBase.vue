<template>
  <WorkspaceFrame mode="knowledge" title="个人资料" eyebrow="PRIVATE KNOWLEDGE" mark="知">
    <template #actions>
      <button type="button" class="knowledge-upload" @click="fileInput?.click()">＋ 上传资料</button>
